      ...
      <div className={cn("w-full", containerClassName)}>
        ...
        <div className="relative">
          <select
            ...
            id={selectId}
            className={cn(
              'w-full appearance-none rounded-lg border border-harven-border bg-harven-bg px-4 py-2.5 pr-10 text-sm text-white transition-colors duration-150 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-50 disabled:cursor-not-allowed',
